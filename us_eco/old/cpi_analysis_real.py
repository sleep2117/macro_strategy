...
def save_cpi_data_to_csv(file_path=repo_path('us_eco', 'cpi_data.csv')):
    """
...
def load_cpi_data_from_csv(file_path=repo_path('us_eco', 'cpi_data.csv')):
    """
    CSV 파일에서 CPI 데이터 로드
...
def load_all_cpi_data(start_date='2020-01-01', series_list=None, force_reload=False, csv_file=repo_path('us_eco', 'cpi_data.csv')):
    """
